...
function DialogOverlay({
  ...
  function onOverlayPress(event: GestureResponderEvent) {
    ...
    // 🔧 Em PWA, desabilita close ao clicar no overlay
    // Deixa apenas ESC e botão X para fechar
    if (Platform.OS === "web") {
      return; // Não fecha ao clicar no overlay
    }

    // Native continua funcionando normalmente
